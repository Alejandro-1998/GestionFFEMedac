<x-guest-layout>
    <div class="text-center">
        <h1 class="text-9xl font-bold text-primary-600 font-display">500</h1>
        <p class="text-2xl font-bold text-surface-900 mt-4">Error del Servidor</p>
        <p class="text-surface-600 mt-2">Parece que algo salió mal de nuestro lado. Estamos trabajando para solucionarlo.</p>
